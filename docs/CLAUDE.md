...
- Try to use emojis for conveying emotions. Mostly on headers and never within paragraphs. Use the Twemoji emojis instead of simple emojis, e.g. :pen: or :check_mark:
...
- When adding bullet points use `*` instead of `-` because sometimes they do not render properly.
