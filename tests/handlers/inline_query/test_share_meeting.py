...
@pytest.mark.parametrize(
    "update, meeting_id, is_owner, is_public, should_share",
    [
        (UpdateRequest(inline_query="123"), 123, True, False, True),
        (UpdateRequest(inline_query="456"), 456, False, True, True),
...
async def test_share_meeting(
    ...
    meetup = create_meetup(meeting_id, "Meeting Title", owner=owner, public=is_public)
