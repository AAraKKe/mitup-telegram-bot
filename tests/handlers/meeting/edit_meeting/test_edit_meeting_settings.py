...
@pytest.fixture
def api():
    with MockApi.start("mitup_bot.handlers.edit_meeting.edit_meeting_settings") as api:
        yield api
...
async def test_edit_default_options_view(
    ...
    contex, _ = await call_handler(update, app, EditMeetingHandlerId.MEETING_SETTINGS_CALLBACK)
