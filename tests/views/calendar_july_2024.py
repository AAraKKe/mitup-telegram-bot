...
TEST_CALENDAR_MARKUP = [
    # Weekdays
    [
        ButtonConfig(text=Weekday.MONDAY.get(), callback_data=cb.EMPTY),
        ButtonConfig(text=Weekday.TUESDAY.get(), callback_data=cb.EMPTY),
        ButtonConfig(text=Weekday.WEDNESDAY.get(), callback_data=cb.EMPTY),
        ButtonConfig(text=Weekday.THURSDAY.get(), callback_data=cb.EMPTY),
        ButtonConfig(text=Weekday.FRIDAY.get(), callback_data=cb.EMPTY),
        ButtonConfig(text=Weekday.SATURDAY.get(), callback_data=cb.EMPTY),
        ButtonConfig(text=Weekday.SUNDAY.get(), callback_data=cb.EMPTY),
    ],
    # Actual calendar
    [
        ButtonConfig(
