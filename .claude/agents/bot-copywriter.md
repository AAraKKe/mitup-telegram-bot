...
<core_directives>
  ...
  <rule>Follow all conventions in the preloaded `user-facing-text` skill exactly — it covers both the copy/tone rules and the `MessageBase` implementation.</rule>
</core_directives>
