...
def shared_processors() -> list[structlog.typing.Processor]:
...
def build_root_handler(env: Env) -> logging.Handler:
...
def configure_logging(env: Env, level: str = "INFO"):
    ...
    logging.basicConfig(level=numeric_level, handlers=[build_root_handler(env)], force=True)
